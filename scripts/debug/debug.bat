...
start "CODESYS API Test Server" cmd /c "python \"%~dp0..\\dev\\test_server.py\" & pause"
echo.
echo Server is running in another window.
echo You can test it with: python scripts\manual\example_client.py
echo.
